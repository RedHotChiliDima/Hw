...
namespace CharacterCreator
{
    public partial class MainWindow : Window
    {
       ...
       RoutedEventArgs e)
        ...
        private void RandomButton_Click(object sender,
       RoutedEventArgs e)
        {
            Random random = new Random();

            // Случайное имя
            string[] names = { "Артур", "Мерлин", "Леголас",
                                    "Арагорн", "Гэндальф",
                                     "Торин", "Боромир",
                                    "Фарамир" };
            NameTextBox.Text =
           names[random.Next(names.Length)];
            ...
            // Случайный класс
            RadioButton[] classRadios = { WarriorRadio,
                    MageRadio, ArcherRadio, RogueRadio };

            classRadios[random.Next(classRadios.Length)].IsChecked = true;

            // Случайные навыки (от 1 до 3)
            CheckBox[] skillChecks = { SmithingCheck,
                        AlchemyCheck, PotionCheck,
                         LockpickCheck,
                        StealthCheck };
            ...
            var shuffled = skillChecks.OrderBy(x =>
           random.Next()).Take(skillCount);
        ...
        private void WarriorRadio_Click(object sender, RoutedEventArgs e)
        {
            AlchemyCheck.IsChecked = false;
        ...
        private void RogueRadio_Click(object sender, RoutedEventArgs e)
        {
            SmithingCheck.IsChecked = false;
        ...
        private void ArcherRadio_Click(object sender, RoutedEventArgs e)
        {
            LockpickCheck.IsChecked = false;
        ...
        private void MageRadio_Click(object sender, RoutedEventArgs e)
        {
            SmithingCheck.IsChecked = false;
            SmithingCheck.IsEnabled = false;
